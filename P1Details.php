        ...
        <div class="small-container single-product">
            <div class="row">
                ...
                <form action="includes/addcart.inc.php" method="POST">
                    <img src="images/Product1.webp" width="50%" id="ProductImg">
                    <input type="hidden" name="img_src" id="img_src" value="images/Product1.webp"> <!-- Hidden input for image source -->
                    <div class="small-img-row">
                        <div class="small-img-col">
                            <img src="images/Product1.webp" width="50%" class="small-img">
                        </div>
                        <div class="small-img-col">
                            <img src="images/Product1(2).webp" width="50%" class="small-img">
                        </div>
                        <div class="small-img-col">
                            <img src="images/Product1(3).webp" width="50%" class="small-img">
                        </div>
                        <div class="small-img-col">
                            <img src="images/Product1(4).webp" width="50%" class="small-img">
                        </div>
                    </div>
                    ...
                    <div class="col-2">
                        ...
                        <!-- GETTING INFO TO DB -->
                        <h1 name='name'>LUXHOLM® Daruma Creed Shirt</h1>
                        <input type="hidden" name="name" value="LUXHOLM® Daruma Creed Shirt">
                        <h4 name='price'>₱1,299.00</h4>
                ...
                <!--  -->
                    ...
                    <p><b>Description:</b><br>The Kuufuku Daruma Creed Shirt is a 
                        carefully crafted piece using a custom cotton-<br>polyester blend, 
                        constructed using 36/2 CVC Single Construction method that<br>ensures 
                        durability and comfort. Features iconic Skoop elements including a 
                        Daruma-<br>inspired designs; symbols of perseverance and good luck. .</p>
...
<script>
    ...
    <div class="row">
        ...
        <a href="P5Details" class="col-1">
            ...
            <h4 style="font-size: 15px;">LUXHOLM® Ryuu Shirt Dark Blue</h4>
            <p>₱1,800.00</p>
        </a>
        </div>
    </section>
...
document.addEventListener("DOMContentLoaded", function() {
    var ProductImg = document.getElementById("ProductImg");
    var SmallImg = document.getElementsByClassName("small-img");
    var imgSrcInput = document.getElementById("img_src");

    // Function to update main image and hidden input field
    function updateImage(src) {
        ProductImg.src = src;
        imgSrcInput.value = src;
    }

    // Add click event to small images
