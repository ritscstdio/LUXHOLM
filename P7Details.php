...
<div class="user-icon-container">
    ...
    <div>
        <div class="small-container single-product">
            <div class="row">
                <div class="col-2">
                    <img src="images/Product7.webp" width="50%" id="ProductImg">
                    <div class="small-img-row">
                        <div class="small-img-col">
                            <img src="images/Product7.webp" width="50%" class="small-img">
                        </div>
                        <div class="small-img-col">
                            <img src="images/Product7(2).webp" width="50%" class="small-img">
                        </div>
                        <div class="small-img-col">
                            <img src="images/Product7(3).webp" width="50%" class="small-img">
                        </div>
                        <div class="small-img-col">
                            <img src="images/Product7(4).webp" width="50%" class="small-img">
                        </div>
                    </div>
    ...
    <form action="includes/addcart.inc.php" method="POST">
        <h1>LUXHOLM®Nero Sweater Onyx</h1>
        <h4>₱2,499.00</h4>
        <p>Size:</p>
        <select name="size">
            <option>S</option>
        ...
        <input type="hidden" name="name" value="LUXHOLM®Nero Sweater Onyx">
        <input type="hidden" name="price" value="2499.00">
        <!-- Update the image source as needed -->
        <input type="hidden" name="img_src" value="images/Product7.webp">
    </form>
                    <h3 style="margin-top: 20px;">Product Details:</h3>
                    <p><b>Description:</b><br>Show the world your impeccable and personal 
                        style with  Nero Sweater<br> Onyx. This sweater is not just
                        clothing; but it is YOU: a reflection of your street-smart<br>   attitude 
                        and fashion-forward mindset. The fabric is carefully selected for its
                        durability<br> that makes it a standout piece of modern aesthetics and comfort. </p>

                    <p><b>Fabric Composition:</b><br>CVC 30/1 Fleece with brushing (360gsm French Terry With Brushing) </p>
                    <p style="margin: 5px 0;"><b>Material:</b><br>30% polyester, 70% cotton blend </p>
                    <p style="margin: 5px 0;"><b>Printing Technique:</b><br>Sweater with Printed Graphic Text on Sleeve "TEAM LUXHOLM"</p>
                    <p></p>
...
<script>
    ...
    <div class="row">
        ...
        <a href="P8Details" class="col-1">
            <img src="images/Product8.webp">
            <h4 style="font-size: 15px;">LUXHOLM®Nero Crew Neck Shirt Onyx</h4>
            <p>₱1,799.00</p>
        </a>
        </div>
    </section>
