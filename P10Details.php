...
<div class="user-icon-container">
    ...
    <section>
        <div class="small-container single-product">
            <div class="row">
                <div class="col-2">
                    <img src="images/Product10.webp" width="50%" id="ProductImg">
                    <div class="small-img-row">
                        <div class="small-img-col">
                            <img src="images/Product10.webp" width="50%" class="small-img">
                        </div>
                        <div class="small-img-col">
                            <img src="images/Product10(2).webp" width="50%" class="small-img">
                        </div>
                        <div class="small-img-col">
                            <img src="images/Product10(3).webp" width="50%" class="small-img">
                        </div>
                        <div class="small-img-col">
                            <img src="images/Product10(4).webp" width="50%" class="small-img">
                        </div>
                    </div>
    ...
    <form action="includes/addcart.inc.php" method="POST">
        <h1>Evergreen Shirt Milk White</h1>
        <h4>₱1,299.00</h4>
        <p>Size:</p>
        <select name="size">
            <option>S</option>
        ...
        <input type="hidden" name="name" value="Evergreen Shirt Milk White">
        <input type="hidden" name="price" value="1299.00">
        <!-- Update the image source as needed -->
        <input type="hidden" name="img_src" value="images/Product10.webp">
    </form>
                
                    <h3 style="margin-top: 20px;">Product Details:</h3>
                    <p><b>Description:</b><br>What sets the KUUFUKU Inverted K 
                    Shirts apart is the meticulous dedication to<br> detailing that
                    reflects LUXHOLMS's commitment to excellence. Adorning the shirts 
                    are the<br> striking inverted K (Kommunity) patches, attentively placed 
                    to create a visually<br> arresting and edgy look. The embroidery and custom 
                    jacquard ribbing further<br> enhances this SKOOP Kompanion, adding a touch of 
                    intricacy to the design. </p>
