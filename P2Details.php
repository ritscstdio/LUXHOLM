    ...
    <div class="row">
        <div class="col-2">
            ...
            <form action="includes/addcart.inc.php" method="POST">
                <!-- Main Product Image -->
                <img src="images/Product2.webp" width="50%" id="ProductImg">
                <input type="hidden" name="img_src" id="img_src" value="images/Product2.webp"> <!-- Hidden input for image source -->

                <!-- Thumbnail Images -->
                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="images/Product2.webp" width="50%" class="small-img" onclick="updateMainImage('images/Product2.webp')">
                    </div>
                    <div class="small-img-col">
                        <img src="images/Product2(2).webp" width="50%" class="small-img" onclick="updateMainImage('images/Product2(2).webp')">
                    </div>
                    <div class="small-img-col">
                        <img src="images/Product2(3).webp" width="50%" class="small-img" onclick="updateMainImage('images/Product2(3).webp')">
                    </div>
                    <div class="small-img-col">
                        <img src="images/Product2(4).webp" width="50%" class="small-img" onclick="updateMainImage('images/Product2(4).webp')">
                    </div>
                </div>
        </div>

        <div class="col-2">
            <h1 name='name'>LUXHOLM® Checkered Jersey</h1>
            <input type="hidden" name="name" value="LUXHOLM® Checkered Jersey">
            <h4 name='price'>₱1,595.00</h4>
            ...
            <p><b>Description:</b><br>The LUXHOLM® Checkered Kommunity Jersey doesn't just stand out for its aesthetic<br> 
                appeal–it's also engineered for performance. Utilizing advanced full sublimation<br>
                printing technique, the design is seamlessly integrated into the fabric, ensuring<br>
                vibrant colors that won't fade over time. This innovative printing method not only<br>
                enhances the visual impact but also ensures long-lasting wear and tear resistance for<br>
                your worry-free days.</p>

            <p><b>Fabric Composition:</b><br>Polyester </p>
            <p style="margin: 5px 0;"><b>Material:</b><br> Jersey</p>
            <p style="margin: 5px 0;"><b>Printing Technique:</b><br> Full Sublimation Printing</p>
...
<script>
    ...
    <div class="row">
        ...
        <a href="P3Details" class="col-1">
            <img src="images/Product3.webp">
            <h4 style="font-size: 15px;">LUXHOLM® Greed Gang Shirt</h4>
            <p>₱1,299.00</p>
        </a>
