...
<div class="user-icon-container">
    ...
    <div>
        <div class="small-container single-product">
            <div class="row">
                <div class="col-2">
                    <img src="images/Product9.webp" width="50%" id="ProductImg">
                    <div class="small-img-row">
                        <div class="small-img-col">
                            <img src="images/Product9.webp" width="50%" class="small-img">
                        </div>
                        <div class="small-img-col">
                            <img src="images/Product9(2).webp" width="50%" class="small-img">
                        </div>
                        <div class="small-img-col">
                            <img src="images/Product9(3).webp" width="50%" class="small-img">
                        </div>
                        <div class="small-img-col">
                            <img src="images/Product9(4).webp" width="50%" class="small-img">
                        </div>
                    </div>
    ...
    <form action="includes/addcart.inc.php" method="POST">
        <h1>Daruma Creed Shirt Milk White</h1>
        <h4>₱1,299.00</h4>
        <p>Size:</p>
        <select name="size">
            <option>S</option>
        ...
        <input type="hidden" name="name" value="Daruma Creed Shirt Milk White">
        <input type="hidden" name="price" value="1299.00">
        <!-- Update the image source as needed -->
        <input type="hidden" name="img_src" value="images/Product9.webp">
    </form>
                    <h3 style="margin-top: 20px;">Product Details:</h3>
                    <p><b>Description:</b><br>The Kuufuku Daruma Creed Shirt is a carefully
                        crafted piece using a custom cotton-<br>polyester blend, constructed using
                        36/2 CVC Single Construction method that<br>ensures durability and comfort.
                        Features iconic Skoop elements including a Daruma-<br>inspired design; symbols
                        of perseverance and good luck. </p>
...
<script>
    ...
    <div class="row">
        ...
        <a href="P10Details" class="col-1">
            <img src="images/Product10.webp">
            <h4 style="font-size: 15px;">Grey Polo</h4>
            <p>20php</p>
        </a>
        </div>
    </section>
