...
<div class="user-icon-container">
    ...
    <div>
        <div class="small-container single-product">
            <div class="row">
                <div class="col-2">
                    <img src="images/Product8.webp" width="50%" id="ProductImg">
                    <div class="small-img-row">
                        <div class="small-img-col">
                            <img src="images/Product8.webp" width="50%" class="small-img">
                        </div>
                        <div class="small-img-col">
                            <img src="images/Product8(2).webp" width="50%" class="small-img">
                        </div>
                        <div class="small-img-col">
                            <img src="images/Product8(3).webp" width="50%" class="small-img">
                        </div>
                        <div class="small-img-col">
                            <img src="images/Product8(4).webp" width="50%" class="small-img">
                        </div>
                    </div>
    ...
    <form action="includes/addcart.inc.php" method="POST">
        <h1>LUXHOLM®Nero Crew Neck Shirt Onyx</h1>
        <h4>₱1,799.00</h4>
        <p>Size:</p>
        <select name="size">
            <option>S</option>
        ...
        <input type="hidden" name="name" value="LUXHOLM®Nero Crew Neck Shirt Onyx">
        <input type="hidden" name="price" value="1799.00">
        <!-- Update the image source as needed -->
        <input type="hidden" name="img_src" value="images/Product8.webp">
    </form>
                    <h3 style="margin-top: 20px;">Product Details:</h3>
                    <p><b>Description:</b><br>Your LUXHOLM adventure is callin’--so live’ life,
                        one Nero Box Fit Shirt at a time.<br> Featuring the French Terry fabric
                        LUXHOLM has grown to love, this tee showcases<br> debossed print in the neck
                        ribbing. And, to top it all up—rubber-engraved authenticity<br> label at 
                        the bottom. </p>

                    <p><b>Fabric Composition:</b><br>Rubber engraved authenticity label </p>
                    <p style="margin: 5px 0;"><b>Material:</b><br>French Terry CVC material </p>
                    <p style="margin: 5px 0;"><b>Printing Technique:</b><br>Woven Patches on Sleeve</p>
                    <p></p>
...
<script>
    ...
    <div class="row">
        ...
        <a href="P6Details" class="col-1">
            <img src="images/Product6.webp">
            <h4 style="font-size: 15px;">LUXHOLM®Retail Therapy Hoodie Tan</h4>
            <p>₱2,695.00</p>
        </a>
        ...
        <a href="P9Details" class="col-1">
            <img src="images/Product9.webp">
            <h4 style="font-size: 15px;">Daruma Creed Shirt Milk White</h4>
            <p>₱1,299.00</p>
        </a>
        </div>
    </section>
