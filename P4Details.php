...
<div class="user-icon-container">
    ...
    <div>
        <div class="small-container single-product">
            <div class="row">
                <div class="col-2">
                    <img src="images/Product4.webp" width="50%" id="ProductImg">
                    <div class="small-img-row">
                        <div class="small-img-col">
                            <img src="images/Product4.webp" width="50%" class="small-img">
                        </div>
                        <div class="small-img-col">
                            <img src="images/Product4(2).webp" width="50%" class="small-img">
                        </div>
                        <div class="small-img-col">
                            <img src="images/Product4(3).webp" width="50%" class="small-img">
                        </div>
                        <div class="small-img-col">
                            <img src="images/Product4(4).webp" width="50%" class="small-img">
                        </div>
                    </div>
    ...
    <form action="includes/addcart.inc.php" method="POST">
        <h1>LUXHOLM® FILA Own It Shirt</h1>
        <h4>₱2,099.00</h4>
        <p>Size:</p>
        <select name="size">
            <option>S</option>
        ...
        <!-- Hidden input fields -->
        <input type="hidden" name="name" value="LUXHOLM® FILA Own It Shirt">
        <input type="hidden" name="price" value="2099.00">
        <input type="hidden" name="img_src" value="images/Product4.webp">
    </form>
                    <h3 style="margin-top: 20px;">Product Details:</h3>
                    <p><b>Description:</b><br>Introducing the new pinnacle of style and comfort:
                         The LUXHOLM® technical<br> marvel in apparel. Constructed from a durable 
                         cotton-spandex blend, these shirts<br> boast the composition of durability 
                         and visual impact. Crafted with passion and 95%<br> cotton, 5% spandex for 
                         optimal comfort and flexibility.</p>

                    <p><b>Fabric Composition:</b><br> 220 GSM: 95%cotton & 5% spandex </p>
                    <p style="margin: 5px 0;"><b>Material:</b><br>The soft and breathable cotton fabric ensures all-day comfort.</p>
                    <p style="margin: 5px 0;"><b>Printing Technique:</b><br>Exclusivity using the puffy and silk-screen printing technique.</p>
                    <p></p>
