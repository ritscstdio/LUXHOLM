...
<div class="user-icon-container">
    ...
    <div>
        <div class="small-container single-product">
            <div class="row">
                <div class="col-2">
                    <img src="images/Product5.webp" width="50%" id="ProductImg">
                    <div class="small-img-row">
                        <div class="small-img-col">
                            <img src="images/Product5.webp" width="50%" class="small-img">
                        </div>
                        <div class="small-img-col">
                            <img src="images/Product5(2).webp" width="50%" class="small-img">
                        </div>
                        <div class="small-img-col">
                            <img src="images/Product5(3).webp" width="50%" class="small-img">
                        </div>
                        <div class="small-img-col">
                            <img src="images/Product5(4).webp" width="50%" class="small-img">
                        </div>
                    </div>
    ...
    <form action="includes/addcart.inc.php" method="POST">
        ...
        <input type="hidden" name="name" value="LUXHOLM® Ryuu Shirt">
        <input type="hidden" name="price" value="1800.00">
        <input type="hidden" name="img_src" value="images/Product5.webp">
    </form>
                    <h3 style="margin-top: 20px;">Product Details:</h3>
                    <p><b>Description:</b><br>The RYUU Shirt is made of Skoop-developed cotton-polyester
                         blend, built to be<br>  comfortable, breathable and durable. This carefully crafted 
                         piece features iconic<br> Skoop elements including a new set of prints commemorating 
                         the year of the dragon,<br>the perfect partner for any endeavor..</p>

                    <p><b>Fabric Composition:</b><br> CVC Cotton (Cotton-Polyester Blend) </p>
                    <p style="margin: 5px 0;"><b>Material:</b><br>Cotton Polyester.</p>
                    <p style="margin: 5px 0;"><b>Printing Technique:</b><br>Woven.</p>
                    <p></p>
